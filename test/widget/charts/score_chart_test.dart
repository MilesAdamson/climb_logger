...
void main() {
  const gradingSystem = VerminSystem();
  ...
  final chartTypes = ChartType.values
      .where((type) => type.availableYAxisTypes.contains(ChartYAxisType.score));
          ...
          home: BlocProvider<AppStateBloc>(
            ...
            child: ChartScreen(
              args: ChartScreenArgs(
                chartType,
                ChartSettingsModel(true, true, true, true, ChartYAxisType.score,
                    gradingSystem),
                entries,
              ),
            ),
