...
void main() {
  const gradingSystem = FrenchSportSystem();
  ...
  final charts = ChartType.values
      .where((type) => type.availableYAxisTypes.contains(ChartYAxisType.sport));

  group("French Sport Charts", () {
          ...
          home: BlocProvider<AppStateBloc>(
            ...
            child: ChartScreen(
              args: ChartScreenArgs(
                chartType,
                ChartSettingsModel(true, true, true, true, ChartYAxisType.sport,
                    gradingSystem),
                entries,
              ),
            ),
